"""TaxDisclosureAgent — Phase 2 (placeholder)."""
...
class TaxDisclosureAgent(BaseAgent):
    AGENT_ID = "TAX_DISCLOSURE_AGENT_v2"
    MODULE = "tax"

    def get_system_prompt(self, context: AgentContext, *, include_state: bool = False) -> str:
        return "TaxDisclosureAgent — not yet implemented (Phase 2)."
